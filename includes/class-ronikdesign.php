...
class Ronikdesign
{
	...
	private function define_admin_hooks()
	{
		...
		$this->loader->add_action('acf/init', $plugin_admin, 'ronikdesigns_acf_op_init_fields', 10);
		$this->loader->add_action('acf/init', $plugin_admin, 'ronikdesigns_acf_op_init_functions', 20);
