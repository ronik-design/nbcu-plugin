...
class UserSyncHandler
{
    ...
    private function get_query_args($type, $params)
    {
        ...
        switch ($type) {
            ...
            case 'option2':
                ...
                error_log("Option2 args before return: " . print_r($args, true));
    ...
    public function process_sync($params)
    {
        try {
            ...
            error_log("Final args for $type: " . print_r($args, true));
            $user_query = new WP_User_Query($args);
            $users = $user_query->get_results();
    ...
    public function delete_users($results, $create_backup = false)
    {
        ...
        $all_meta_keys = [
            ...
            'user_email',
            'is_ae',
            'wp_3_last_approval_sent',
            'user_confirmed',
            'user_log',
            'resend-register-email-count',
            'send-forgot-pass-email-count',
            'last_login',
            'lockout_until',
            'login_attempts',
            'login_history',
            ...
            'remember_key',
            'wpseo_ignore_tour',
            'manageusers_page_nbcu-userscolumnshidden',
            'wp_capabilities',
            'wp_user_level',
            'community-events-location',
            'wp_3_ac_preferences_sorted_by',
            'wp_3_ac_preferences_layout_table',
            'wp_7_capabilities',
            'wp_7_user_level',
            'wp_7_dashboard_quick_press_last_post_id',
            'wp_5_capabilities',
            'wp_5_user_level',
            'wp_6_capabilities',
            'wp_6_user_level',
            ...
            'wp_3_ac_preferences_settings',
            'ac_preferences_admin_screen_options',
            '_network',
            'user_history',
            'restricted_whitelist',
            'wp_3_approval_email_path',
            'registration_sent_email',
            'register_history',
            ...
            'user_twitter',
            'last_modified',
            'closedpostboxes_site-options_page_whitelist-option',
            'metaboxhidden_site-options_page_whitelist-options',
            'closedpostboxes_videos',
            'metaboxhidden_videos',
            'wp_3_user-settings',
            'wp_3_user-settings-time',
            'wp_3_media_library_mode',
            'edit_acf-field-group_per_page',
            'wp_6_user-settings',
            'wp_6_user-settings-time',
            'user_click_actions',
            'wp_2_user-settings',
            'wp_7_ac_preferences_layout_table',
            'wp_7_ac_preferences_sorted_by',
            'edit_talent_per_page',
            'wp_7_user-settings',
            'wp_7_user-settings-time',
            '_yoast_wpseo_introductions',
            'user_tracker_actions',
            'ae_beta_features',
            'wp_6_dashboard_quick_press_last_post_id',
            'last_viewed_notifications',
            'user_password_tracker_actions',
            'ronikdesign_initialization_vector',
            'wp_approval_hash',
            'ronik_history_registration',
            'wp_user-settings-time-password-reset',
            'sms_code_timestamp',
            'auth_lockout_counter',
            'ronik_password_history',
            'pat_contact_id',
            'wp_5_user-settings',
            'wp_5_user-settings-time',
            'meta-box-order_page',
            'screen_layout_page',
            'closedpostboxes_talent',
            'metaboxhidden_talent',
            'wp_7_ac_preferences_editability_state',
            'manageedit-acf-ui-options-pagecolumnshidden',
            'acf_user_settings',
            'meta-box-order_site-options_page_whitelist-options',
            'screen_layout_site-options_page_whitelist-options',
            'dynamic_user_login_url',
            'wp_7_ac_preferences_settings',
    ...
    private function analyze_user($user, $bad_words, $whitelist_domains, $burner_domains, $spammy_patterns)
    {
        ...
        if (
            str_ends_with($domain, '.xyz') || str_contains($email, 'noreply') ||
