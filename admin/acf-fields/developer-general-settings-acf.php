...
if (function_exists('acf_add_local_field_group')) :
	...
	acf_add_local_field_group(array(
		...
		'fields' => array(
			...
			array(
				'key' => 'field_639a4921626d3sasaa_ronikdesign',
				'label' => 'Specify URL you want to avoid being "CSP Enabled"',
				'name' => 'csp_disallow-url',
				'aria-label' => '',
				'type' => 'repeater',
				'instructions' => 'Please include only the route url',
				'required' => 0,
				'conditional_logic' => 0,
				'wrapper' => array(
					'width' => '',
				...
				'sub_fields' => array(
					array(
						'key' => 'field_639a4adcfc742sasaa_ronikdesign',
						'label' => 'Handle',
						'name' => 'handle',
						'aria-label' => '',
						'type' => 'text',
						...
						'prepend' => '',
						'append' => '',
						'parent_repeater' => 'field_639a4adcfc742sasaa_ronikdesign',
					),
				),
			),
...
https://test.com/',
			...
			array(
				...
				'sub_fields' => array(
					...
					array(
						'key' => 'field_64822e6696e0f2jjhsdjsjh_ronikdesign',
						'label' => 'Background Image',
						'name' => 'auth_content_bgimage',
						'aria-label' => '',
						'type' => 'image',
						'instructions' => '',
						'required' => 0,
					...
					array(
						...
						'label' => 'Auth Content Title:',
						'name' => 'auth_content_title',
						'type' => 'textarea',
					...
					array(
						...
						'label' => 'Auth Missing SMS Content Title:',
						'name' => 'auth_missing-sms_content_title',
						'type' => 'textarea',
						'instructions' => 'This will display as the Auth main Content.',
						'required' => 0,
						'conditional_logic' => 0,
					...
					array(
						...
						'label' => 'MFA Content Title:',
						'name' => 'mfa_content_title',
						'type' => 'textarea',
					...
					array(
						'key' => 'field_6372afa6da3f200c2_ronikdesign',
						'label' => 'MFA Instructions Content:',
						'name' => 'mfa_instructions_content',
						'type' => 'wysiwyg',
					...
					array(
						...
						'label' => 'MFA Post Registration Content Title:',
						'name' => 'mfa_post_content_title',
						'type' => 'wysiwyg',
						'instructions' => 'This will display as the MFA main Content.',
						'required' => 0,
						'conditional_logic' => 0,
					...
					array(
						...
						'name' => 'enable_2fa_settings',
						'type' => 'true_false',
						'instructions' => 'This will enable SMS 2fa settings.',
						'required' => 0,
						'conditional_logic' => 0,
						'wrapper' => array(
							'width' => '100',
					...
					array(
						...
						'label' => '2fa Content Title:',
						'name' => '2fa_content_title',
						'type' => 'textarea',
					...
					array(
						...
						'label' => '2fa Post Content Title:',
						'name' => '2fa_post_content_title',
						'type' => 'textarea',
						'instructions' => 'This will display as the 2fa main Content.',
						'required' => 0,
						'conditional_logic' => 0,
					...
					array(
						...
						'label' => 'Please select the pages you wish to have MFA & 2FA Enabled on.',
						'name' => 'auth_page_enabled',
						'aria-label' => '',
						'type' => 'repeater',
						'instructions' => '',
						'required' => 0,
						...
						'sub_fields' => array(
							array(
								...
								'max' => 1,
								'elements' => '',
								'parent_repeater' => 'field_64aaf98087583',
							),
						),
					),
			...
			array(
				...
				'sub_fields' => array(
					...
					array(
						'key' => 'field_6372afa6da3f2021acc_ronikdesign',
						'label' => 'Specify File Path and or Page Path',
						'name' => 'serviceworker_script_loader',
						'aria-label' => '',
						'type' => 'repeater',
						'instructions' => 'By default the application will try to auto populate the service workers images, scripts, styles & domain paths. However if a certain path or script or style is not working on offline mode please add the link below. Please remove any root domain including protocal. <br><br> Wrong Way: https://kmancuso.com/project-details/atlantic-landscape/. <br>Correct Way: /project-details/atlantic-landscape/',
						'required' => 0,
						'conditional_logic' => 0,
						'wrapper' => array(
							'width' => '',
						...
						'sub_fields' => array(
							array(
								'key' => 'field_6372afa6da3f2021accb_ronikdesign',
								'label' => 'Script',
								'name' => 'script',
								'aria-label' => '',
								'type' => 'text',
								...
								'prepend' => '',
								'append' => '',
								'parent_repeater' => 'field_6372afa6da3f2021acc_ronikdesign',
							),
							array(
								'key' => 'field_6372afa6da3f2021accbc_ronikdesign',
								'label' => 'Enable Cache Busting',
								'name' => 'enable_cache_busting',
								'aria-label' => '',
								'type' => 'true_false',
								'instructions' => '',
								'required' => 0,
